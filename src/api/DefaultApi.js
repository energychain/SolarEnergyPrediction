...
export class DefaultApi {
    ...
    */
     ...
     * @callback moduleapi/DefaultApi~v20SolarPredictionGetCallback
     ...
     * @param {module:api/DefaultApi~v20SolarPredictionGetCallback} callback The callback function, accepting three arguments: error, data, response
