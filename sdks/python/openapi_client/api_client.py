...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.prediction  # this is an instance of the class Endpoint
        api_instance.prediction()  # this invokes api_instance.prediction.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.prediction.callable or self.callable in this class
